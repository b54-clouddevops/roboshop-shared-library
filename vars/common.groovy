def sonarChecks(){
    sh ''' 
        ...
        sonar-scanner -Dsonar.sources=. -Dsonar.java.binaries=target/ -Dsonar.login=1cbe0f6f0cdbd9bb3ff8d78b880f7fb417eb4321  -Dsonar.host.url=http://172.31.86.248:9000 -Dsonar.projectKey=${COMPONENT}
